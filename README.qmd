...
The general idea is to test the development of [`microclimr`](https://github.com/sylvainschmitt/microclimr) by reproducing analyses of the IMRPINT project on the forest microclimate from the Mormal, Blois and Aigoual forests.

## Usage

**fourier** analyses rely on the quarto documents `index.qmd`, `supplementary_note.qmd` and `cover_letter.qmd`  that can be run with R and associated environment defined with [renv](#0).

## Project

**fourier** includes:

- Manuscript and analyse of the data with associated documentation and figures:
